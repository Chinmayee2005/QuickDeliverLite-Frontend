...
const Feedback = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const deliveryRes = await axios.get('https://quickdeliverlite-backend-1.onrender.com/api/feedback/deliveries', {
        params: { email: userEmail }
      });

      const feedbackRes = await axios.get('https://quickdeliverlite-backend-1.onrender.com/api/feedback/all');
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    await axios.post('https://quickdeliverlite-backend-1.onrender.com/api/feedback', {
