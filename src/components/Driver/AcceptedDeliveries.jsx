...
const AcceptedDeliveries = () => {
  ...
  useEffect(() => {
    ...
    if (storedEmail && storedRole === "Driver") {
      ...
      axios
        .get(`https://quickdeliverlite-backend-1.onrender.com/api/delivery/accepted?email=${storedEmail}`)
  ...
  const handleStatusChange = async (id, newStatus) => {
    if (newStatus === "delivered") {
      try {
        await axios.post("https://quickdeliverlite-backend-1.onrender.com/api/otp/send-otp", { deliveryId: id });
      ...
      axios
        .put(`https://quickdeliverlite-backend-1.onrender.com/api/delivery/status/${id}`, { newStatus })
        .then(() => {
          setDeliveries((prev) =>
  ...
  const verifyOtpAndMarkDelivered = () => {
    axios
      .post("https://quickdeliverlite-backend-1.onrender.com/api/otp/verify-otp", {
