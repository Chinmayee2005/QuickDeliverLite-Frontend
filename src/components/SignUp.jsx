...
export default function SignUp() {
  ...
  const sendCode = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://quickdeliverlite-backend-1.onrender.com/api/auth/send-code", {
        email: form.email,
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post("https://quickdeliverlite-backend-1.onrender.com/api/auth/register", form);
      setMessage(res.data.message);
